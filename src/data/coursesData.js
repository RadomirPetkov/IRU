...
const fallbackCourses = [
    ...
    videos: [
      {
        ...
        description:
          "Основни понятия за хардуер и софтуер. Какво е компютър и как работи.",
        duration: "15:30",
        order: 1,
      ...
      },
      {
        ...
        description:
          "Навигация във Windows, файлове и папки, основни настройки.",
        duration: "22:45",
        order: 2,
        category: "Базово ниво",
      },
      {
        ...
        description:
          "Как да сърфираме безопасно в интернет, търсачки и социални мрежи.",
        duration: "18:20",
        order: 3,
        category: "Базово ниво",
      },
      {
        ...
        description:
          "Създаване и управление на имейл акаунт, етикет в електронната комуникация.",
        duration: "20:15",
        order: 4,
        category: "Базово ниво",
      },
  ...
  },
  {
    ...
    description:
      "Напреднали умения за офис приложения и електронна комуникация",
    level: 2,
    ...
    videos: [
      {
        ...
        description:
          "Стилове, шаблони, съвместна работа и рецензиране на документи.",
        duration: "25:10",
        order: 1,
      ...
      },
      {
        ...
        description:
          "Професионални презентации с анимации и интерактивни елементи.",
        duration: "20:40",
        order: 3,
        category: "Средно ниво",
      },
      {
        ...
        description:
          "Google Drive, OneDrive, споделяне и синхронизация на файлове.",
        duration: "18:30",
        order: 4,
        category: "Средно ниво",
      },
...
export const getCoursesStats = async () => {
  try {
    ...
    const averageVideosPerCourse =
      allCourses.length > 0 ? totalVideos / allCourses.length : 0;
...
export const checkForUpdates = async () => {
  try {
    const result = await getFirestoreCourses();
    if (result.success) {
      const firestoreCount = result.data.filter(
        (c) => c.isActive !== false
      ).length;
